...
namespace NBooks.Core.View
{
	...
	public interface IPaymentView : IView
	{
		...
		event PaymentEventHandler SavePayment;
		event PaymentEventHandler SavePaymentAndClose;
		event PaymentEventHandler SavePaymentAndClear;
		event EventHandler ListCustomers;
		event EventHandler ListPaymentMethods;
		event CustomerEventHandler FindInvoices;
	}
}
