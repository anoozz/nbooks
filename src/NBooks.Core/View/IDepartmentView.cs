...
{
	/// <summary>
	/// Description of IDepartmentView.
	/// </summary>
	public interface IDepartmentView : IView
	{
		Department Department { get; set; }
		event DepartmentEventHandler SaveDepartment;
	}
	...
	public interface IDepartmentListView
	{
		...
		event DepartmentEventHandler DeleteDepartment;
		event DepartmentEventHandler MakeInactiveDepartment;
	}
}
