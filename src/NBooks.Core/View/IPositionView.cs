...
{
	/// <summary>
	/// Description of IPositionView.
	/// </summary>
	public interface IPositionView : IView
	{
		Position Position { get; set; }
		event PositionEventHandler SavePosition;
	}
	...
	public interface IPositionListView
	{
		...
		event PositionEventHandler DeletePosition;
		event PositionEventHandler MakeInactivePosition;
	}
}
