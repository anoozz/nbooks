...
{
	/// <summary>
	/// Description of PhysicalCountService.
	/// </summary>
	public class PhysicalCountService : IPhysicalCountService
	{
		IPhysicalCountDao dao;
		
		public PhysicalCountService(IPhysicalCountDao dao)
		{
			this.dao = dao;
		}
		...
		public PhysicalCount Read(int id)
		{
			return dao.Read(id);
		}
		
		public IList<PhysicalCount> FindAll()
		{
			return dao.FindAll();
		}
	}
