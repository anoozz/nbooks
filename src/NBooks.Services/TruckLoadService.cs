...
{
	/// <summary>
	/// Description of TruckLoadService.
	/// </summary>
	public class TruckLoadService : ITruckLoadService
	{
		ITruckLoadDao dao;
		IPrinter printer;
		ITruckLoadFormatter formatter;
		
		public TruckLoadService(ITruckLoadDao dao) : this(dao, null, null)
		{
		}
		
		public TruckLoadService(ITruckLoadDao dao, IPrinter printer, ITruckLoadFormatter formatter)
		{
			this.dao = dao;
		...
		public TruckLoad Read(int id)
		{
			return dao.Read(id);
		}
		
		public IList<TruckLoad> FindAll()
		{
			return dao.FindAll();
		}
