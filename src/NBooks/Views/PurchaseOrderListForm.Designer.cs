...
namespace NBooks.Views
{
	partial class PurchaseOrderListForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.createPurchaseOrdersToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			// columnHeader4
			// 
			this.columnHeader4.Text = "Delivery Date";
			...
			this.contextMenuStrip1.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
									...
									this.createPurchaseOrdersToolStripMenuItem,
			...
			// 
			// createPurchaseOrdersToolStripMenuItem
			// 
			this.createPurchaseOrdersToolStripMenuItem.Name = "createPurchaseOrdersToolStripMenuItem";
			this.createPurchaseOrdersToolStripMenuItem.Size = new System.Drawing.Size(201, 22);
			this.createPurchaseOrdersToolStripMenuItem.Text = "Create Purchase Orders";
			// 
			// editTransactionToolStripMenuItem
			// 
			this.editTransactionToolStripMenuItem.Name = "editTransactionToolStripMenuItem";
			this.editTransactionToolStripMenuItem.Size = new System.Drawing.Size(201, 22);
			...
			this.toolStripDropDownButton1.Text = "Purchase Order";
			// 
			// toolStrip1
			// 
		...
		private System.Windows.Forms.ToolStripMenuItem createPurchaseOrdersToolStripMenuItem;
