...
{
	partial class PayrollCodeListForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PayrollCodeListForm));
			...
			// columnHeader1
			// 
			this.columnHeader1.Text = "Payroll Code";
			// 
			// columnHeader2
			// 
			...
			this.toolStripDropDownButton1.Text = "Payroll Code";
			// 
			...
			this.Name = "PayrollCodeListForm";
			this.Text = "Payroll Code List";
