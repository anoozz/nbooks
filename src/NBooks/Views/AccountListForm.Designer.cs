...
namespace NBooks.Views
{
	partial class AccountListForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolStripDropDownButtonAccount = new System.Windows.Forms.ToolStripDropDownButton();
			...
			this.listViewAccounts.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
									...
									this.columnHeader2,
									this.columnHeader3});
			this.listViewAccounts.ContextMenuStrip = this.contextMenuStrip1;
			...
			this.listViewAccounts.Name = "listView1";
			this.listViewAccounts.Size = new System.Drawing.Size(292, 240);
			...
			// columnHeader3
			// 
			this.columnHeader3.Text = "Balance Total";
			...
			// 
			// toolStripDropDownButtonAccount
			// 
			this.toolStripDropDownButtonAccount.Image = ((System.Drawing.Image)(resources.GetObject("toolStripDropDownButtonAccount.Image")));
			this.toolStripDropDownButtonAccount.ImageTransparentColor = System.Drawing.Color.Magenta;
			this.toolStripDropDownButtonAccount.Name = "toolStripDropDownButtonAccount";
			this.toolStripDropDownButtonAccount.Size = new System.Drawing.Size(75, 22);
			this.toolStripDropDownButtonAccount.Text = "Account";
			// 
			...
			this.toolStrip1.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
									this.toolStripDropDownButtonAccount,
		...
		private System.Windows.Forms.ToolStripDropDownButton toolStripDropDownButtonAccount;
