...
{
	partial class DeductionTypeListForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DeductionTypeListForm));
			...
			this.toolStripDropDownButton1.Text = "Deduction Type";
			// 
			...
			this.Name = "DeductionTypeListForm";
			this.Text = "Deduction Type List";
