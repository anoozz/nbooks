	...
	public partial class VehicleForm : BaseForm
	{
		...
		public Vehicle Vehicle {
			...
			set { 
				...
				richTextBoxDescription.Text = vehicle.Description;
				checkBoxInactive.Checked = vehicle.Inactive;
			}
		}
		...
		public event EventHandler<VehicleEventArgs> VehicleSave;
		
		protected virtual void OnVehicleSave(VehicleEventArgs e)
		{
			if (VehicleSave != null) {
				VehicleSave(this, e);
			}
		...
		{
			OnVehicleSave(new VehicleEventArgs(Vehicle));
		}
