...
namespace NBooks.Views
{
	partial class PositionListForm
	{
		...
		private void InitializeComponent()
		{
			...
			// listView1
			// 
			this.listViewPositions.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
									this.columnHeader1});
			this.listViewPositions.ContextMenuStrip = this.contextMenuStrip1;
			this.listViewPositions.Dock = System.Windows.Forms.DockStyle.Fill;
			this.listViewPositions.FullRowSelect = true;
			this.listViewPositions.Location = new System.Drawing.Point(0, 0);
			this.listViewPositions.Name = "listView1";
			this.listViewPositions.Size = new System.Drawing.Size(292, 240);
			this.listViewPositions.TabIndex = 11;
			...
			this.toolStripDropDownButton1.Text = "Position";
			// 
			...
			this.Controls.Add(this.listViewPositions);
