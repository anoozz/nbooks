...
{
	partial class VendorTypeListForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(VendorTypeListForm));
			...
			this.toolStripDropDownButton1.Text = "Vendor Type";
			// 
			...
			this.Name = "VendorTypeListForm";
			this.Text = "Vendor Type List";
