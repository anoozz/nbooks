...
{
	partial class SSPremiumListForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SSPremiumListForm));
			...
			// columnHeader1
			// 
			this.columnHeader1.Text = "SSS Premiums";
			// 
			// columnHeader2
			// 
			...
			// columnHeader5
			// 
			this.columnHeader5.Text = "EC";
			this.columnHeader5.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.columnHeader5.Width = 80;
			// 
			// columnHeader6
			// 
			this.columnHeader6.Text = "EE";
			...
			this.toolStripDropDownButton1.Text = "SSS Premium";
			// 
			// toolStrip1
			// 
			...
			this.Name = "SSSPremiumListForm";
			this.Text = "SSS Premium List";
