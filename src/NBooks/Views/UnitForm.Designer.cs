...
namespace NBooks.Views
{
	partial class UnitForm
	{
		...
		private void InitializeComponent()
		{
			...
			// checkBoxInactive
			// 
			this.checkBoxInactive.Location = new System.Drawing.Point(184, 88);
			...
			this.checkBoxInactive.Text = "Unit of measure is inactive";
			...
			// buttonOk
			// 
			this.buttonOk.Location = new System.Drawing.Point(184, 16);
			...
			// textBoxAbbreviation
			// 
			this.textBoxAbbreviation.Location = new System.Drawing.Point(8, 72);
			this.textBoxAbbreviation.Name = "textBoxAbbreviation";
			this.textBoxAbbreviation.Size = new System.Drawing.Size(152, 21);
			this.textBoxAbbreviation.TabIndex = 16;
			// 
			// label2
			// 
