...
{
	partial class PhilHealthPremiumForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.checkBoxInactive.Size = new System.Drawing.Size(128, 36);
			this.checkBoxInactive.TabIndex = 43;
			this.checkBoxInactive.Text = "PhilHealth premium is inactive";
			...
			this.Name = "PhilHealthPremiumForm";
			this.Text = "New PhilHealth Premium";
