...
namespace NBooks.Views
{
	partial class ModuleListForm
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ModuleListForm));
			...
			this.listView1.DoubleClick += new System.EventHandler(this.ModifyToolStripMenuItemClick);
			// 
			// columnHeader1
			// 
			...
			this.editToolStripMenuItem.Click += new System.EventHandler(this.ModifyToolStripMenuItemClick);
			// 
			...
			this.toolStripDropDownButton1.Text = "Module";
			// 
			// toolStrip1
			// 
