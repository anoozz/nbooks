...
{
	partial class PhilHealthPremiumListForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PhilHealthPremiumListForm));
			...
			this.toolStripDropDownButton1.Size = new System.Drawing.Size(126, 22);
			this.toolStripDropDownButton1.Text = "PhilHealth Premium";
			// 
			...
			// columnHeader2
			// 
			this.columnHeader2.Text = "Range From";
			this.columnHeader2.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.columnHeader2.Width = 80;
			// 
			// columnHeader3
			// 
			this.columnHeader3.Text = "Range To";
			this.columnHeader3.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.columnHeader3.Width = 80;
			// 
			// PhilHealthPremiumListForm
			// 
			...
			this.Name = "PhilHealthPremiumListForm";
			this.Text = "PhilHealth Premium List";
