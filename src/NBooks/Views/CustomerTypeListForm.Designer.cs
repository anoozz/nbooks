...
{
	partial class CustomerTypeListForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CustomerTypeListForm));
			...
			this.toolStripDropDownButton1.Text = "Customer Type";
			// 
			...
			this.Name = "CustomerTypeListForm";
			this.Text = "Customer Type List";
