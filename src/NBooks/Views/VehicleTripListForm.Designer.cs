...
{
	partial class VehicleTripListForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(VehicleTripListForm));
			...
			this.listViewTrips.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
									this.columnHeader1});
			this.listViewTrips.ContextMenuStrip = this.contextMenuStrip1;
			this.listViewTrips.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.listViewTrips.Size = new System.Drawing.Size(292, 241);
			this.listViewTrips.TabIndex = 15;
			this.listViewTrips.UseCompatibleStateImageBehavior = false;
			this.listViewTrips.View = System.Windows.Forms.View.Details;
			// 
			// columnHeader1
			// 
			this.columnHeader1.Text = "Vehicle";
			// 
			// contextMenuStrip1
			// 
			...
			this.toolStripDropDownButton1.Text = "Vehicle Trip";
			// 
			...
			this.Name = "VehicleTripListForm";
			this.Text = "Vehicle Trip List";
