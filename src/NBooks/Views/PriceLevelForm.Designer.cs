...
namespace NBooks.Views
{
	partial class PriceLevelForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Price Level Name";
			// 
			// textBoxName
			// 
			...
			// checkBox1
			// 
			this.checkBoxInactive.Location = new System.Drawing.Point(240, 8);
			this.checkBoxInactive.Name = "checkBox1";
			this.checkBoxInactive.Size = new System.Drawing.Size(136, 24);
			this.checkBoxInactive.TabIndex = 4;
			this.checkBoxInactive.Text = "Price level is inactive";
			...
			this.Name = "PriceLevelForm";
			this.Text = "New Price Level";
