	...
	partial class UnitListForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.listViewUnits.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
									this.columnHeader1});
			this.listViewUnits.ContextMenuStrip = this.contextMenuStrip1;
			this.listViewUnits.Dock = System.Windows.Forms.DockStyle.Fill;
			this.listViewUnits.FullRowSelect = true;
			this.listViewUnits.Location = new System.Drawing.Point(0, 0);
			this.listViewUnits.Name = "listView1";
			this.listViewUnits.Size = new System.Drawing.Size(337, 241);
			this.listViewUnits.TabIndex = 12;
			...
			this.toolStripDropDownButton1.Text = "Unit of Measure";
			// 
