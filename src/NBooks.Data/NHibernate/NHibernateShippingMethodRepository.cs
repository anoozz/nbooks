...
{
	public class NHibernateShippingMethodRepository : NHibernateRepository<ShippingMethod>, IShippingMethodRepository
	{
		public NHibernateShippingMethodRepository()
		{
		}
