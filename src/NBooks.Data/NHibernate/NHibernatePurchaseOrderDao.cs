...
{
	/// <summary>
	/// Description of NHibernatePurchaseOrderDao.
	/// </summary>
	public class NHibernatePurchaseOrderDao : NHibernateDao<PurchaseOrder>, IPurchaseOrderRepository
	{
		public NHibernatePurchaseOrderDao()
		{
		}
